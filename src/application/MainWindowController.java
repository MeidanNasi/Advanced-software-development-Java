...
public class MainWindowController implements Initializable, Observer{
	...
	boolean isConnectedToCacl=false;
	boolean isPathCalculated=false;
	// Sample plane position members
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		public void setMwc() {
			colorfulMapDisplayer.setMwc(this);
		}
	
	public void updatedDirectionJoyStick() {
    ...
    public void setViewModel(ViewModel vm) {
        ...
        //vm.pathVm.bind(path);
        this.colorfulMapDisplayer.longitude.bind(vm.longitude);
        this.colorfulMapDisplayer.latitude.bind(vm.latitude);
	...
	public void calculatePath() {
		...
		submit.setOnAction(e -> 
								{ System.out.println("Getting ip&port logic");
								  ...
								  String port = portUserInput.getText();
								  popup.close();
								  path = vm.connectToCalcServerVm(ip, port, colorfulMapDisplayer.matrix, colorfulMapDisplayer.getFirstPosition(), colorfulMapDisplayer.getTargetPosition());
								  System.out.println("soucre:"+colorfulMapDisplayer.getPlanePosition()+" "+"target:"+colorfulMapDisplayer.getTargetPosition());
								  System.out.println("path is:"+path);
								  colorfulMapDisplayer.solutionDrawer(path);
								  isPathCalculated=true;
								});
		isConnectedToCacl=true;
		}
		else {
			path2=vm.getPathFromCalcServerVm(colorfulMapDisplayer.getFirstPosition(),colorfulMapDisplayer.getTargetPosition());
			//colorfulMapDisplayer.solutionDrawer(path);
			//colorfulMapDisplayer.redrawMap();
			colorfulMapDisplayer.setPlanePosition(colorfulMapDisplayer.planePosition.x, colorfulMapDisplayer.planePosition.y);
			colorfulMapDisplayer.solutionDrawer(path2);
			colorfulMapDisplayer.setTragetPosition(colorfulMapDisplayer.targetClickedValX,colorfulMapDisplayer.targetClickedValY);
		}
	...
	public void update(Observable o, Object arg) {
		colorfulMapDisplayer.samplePointPosition();
	}
